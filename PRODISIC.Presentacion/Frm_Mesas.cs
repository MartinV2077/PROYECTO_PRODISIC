...
namespace PRODISIC.Presentacion
{
    public partial class Frm_Mesas : Form
    {
        ...
        private void Formato_me()
        {
            ...
            Dgv_Listado.Columns[1].HeaderText = "PRODISIC MESAS";
            Dgv_Listado.Columns[2].Width = 260;
            Dgv_Listado.Columns[2].HeaderText = "PRODISIC VENTAS";
        ...
        private void Formato_pv()
        {
            ...
            Dgv_1.Columns[1].HeaderText = "PRODISIC VENTAS";
        ...
        private void Selecciona_item()
        {
            ...
            else
            {
                ...
                Txt_Prodisic_venta.Text = Convert.ToString(Dgv_Listado.CurrentRow.Cells["descripcion_pv"].Value);
        ...
        private void Selecciona_item_pv()
        {
            ...
            {
                Txt_Prodisic_venta.Text = Convert.ToString(Dgv_1.CurrentRow.Cells["descripcion_pv"].Value);
        ...
        private void Btn_guardar_Click(object sender, EventArgs e)
        {
            try
            {
                if (Txt_descripcion.Text == String.Empty || Txt_Prodisic_venta.Text == String.Empty)
                {
